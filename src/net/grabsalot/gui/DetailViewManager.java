...
import net.grabsalot.gui.AlbumInfoPanel;
import net.grabsalot.gui.ArtistInfoPanel;
import net.grabsalot.gui.EDetailViewMode;
import net.grabsalot.gui.GenericInfoPanel;
import net.grabsalot.gui.MainFrame;
import net.grabsalot.gui.TrackInfoPanel;
...
public class DetailViewManager {
	...
	private static MainFrame mainFormInstance;
	...
	static {
		mainFormInstance = MainFrame.getInstance();
	...
	static EDetailViewMode getDetailViewMode() {
