	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(this.iRename)) {
			...
			if (this.overNode.getElement().getPath().renameTo(newFile)) {
				...
				MainFrame.getInstance().setStatusBarText(
		...
		if (e.getSource().equals(this.iSaveAlbumArt)) {
			try {
				...
				MainFrame.getInstance().setStatusBarText("Cover art saved as :" + coverFile.getAbsolutePath());
			} catch (Exception ex) {
				MainFrame.getInstance().setStatusBarText("Failed to save cover art :" + ex.getMessage());
			}
		}
		...
		if (e.getSource().equals(this.iPlayTrack)) {
			MainFrame.getInstance().playTrack((LocalTrack) overNode.getElement());
		}
		if (e.getSource().equals(this.iEnqueueTrack)) {
			MainFrame.getInstance().enqueueTrack((LocalTrack) overNode.getElement());
		}
		if (e.getSource().equals(this.iPlayAlbum)) {
			MainFrame.getInstance().playTracks(((LocalAlbum) overNode.getElement()).getTracks());
		}
